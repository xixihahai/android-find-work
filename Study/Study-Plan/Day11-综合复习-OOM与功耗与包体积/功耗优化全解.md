...
| WorkManager | 首选后台任务方案，内部按API选择JobScheduler/AlarmManager/GCMNetworkManager | ★★★★★ |
| Battery Historian | Google官方电量分析工具，可视化展示WakeLock/Alarm/网络/CPU时间线 | ★★★★☆ |
| 后台限制(8.0+) | 后台不能startService，需startForegroundService并5s内调startForeground | ★★★★★ |
...
- **后台限制 → Service(8.0+不能后台启动前台服务)**：后台启动Service需用startForegroundService+通知栏
